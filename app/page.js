  ...
  return (
    <main>
      <section className="heroLegal">
        ...
        <p style={{ display: "flex", gap: 10, flexWrap: "wrap" }}><a href="/dashboard" style={{ display: "inline-flex", marginTop: 22, padding: "12px 18px", borderRadius: 10, background: "#153f32", color: "white", textDecoration: "none", fontWeight: 750 }}>開啟商機工作台</a><a href="/review-demo" style={{ display: "inline-flex", marginTop: 22, padding: "12px 18px", borderRadius: 10, background: "#ff826a", color: "white", textDecoration: "none", fontWeight: 750 }}>Threads 授權與搜尋示範</a></p>
      </section>
